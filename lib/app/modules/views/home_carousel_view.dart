...
class HomeCarouselView extends GetView<HomeViewCTL> {
  ...
  CarouselSlider _allCategoriesViews(List<FirebaseCatagory> otherCategoriesList) {

      List<FirebaseCharecter> listCharacters = [];
      listCharacters=  otherCategoriesList.expand((category)=>category.characters).toList() ;
      listCharacters.shuffle();
      listCharacters.toSet();

      print("All Characters ${listCharacters} ${otherCategoriesList}");
    return  CarouselSlider.builder(itemCount: listCharacters.length,
          ...
          Stack(
            ...
            Container(
              ...
              width: SizeConfig.screenWidth,
               ...
               Container(
                padding: EdgeInsets.only(top: SizeConfig.blockSizeVertical * 5, right: SizeConfig.blockSizeHorizontal * 5, left: SizeConfig.blockSizeHorizontal * 5),
                 child: Row(
